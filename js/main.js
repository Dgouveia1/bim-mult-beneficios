...
import { loadClientsData, handleNewClientSubmit, openModal, addDependenteField, openDetailsModal, handleUpdateClient, filterAndRenderClients, exportToExcel, handleGenerateContract, handleMigratePlanToFamiliar, handleCancelPlan, handleReactivatePlan, handleAlterarVencimentoAsaas } from './clientes.js';
...
function setupEventListeners() {
    ...
    document.body.addEventListener('click', async function (event) {
        ...
        const btnAlterarVenc = target.closest('#btnAlterarVencimentoAsaas');
        if (btnAlterarVenc) handleAlterarVencimentoAsaas();
